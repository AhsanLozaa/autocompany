...
# /Users/ahsanilyas/Documents/assesment/labela_backend_assignment

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],
        # 'DIRS': [BASE_DIR / 'autocompany/templates/autocompany']
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'PORT': config('DB_PORT', default='None', cast=str),
    }
}
